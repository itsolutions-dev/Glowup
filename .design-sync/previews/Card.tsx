...
import { Card, Typography, Divider, Avatar, StatusBadge, Chip, Button } from "@glowup/ui";
...
export const Variants = () => (
  <div style={stack}>
    <Card variant="filled">
      ...
      <Typography variant="bodySmall">Default surface container — the everyday card.</Typography>
    </Card>
    <Card variant="outlined">
      <Typography variant="titleSmall">Outlined</Typography>
      <Typography variant="bodySmall">A hairline outline instead of a tonal fill.</Typography>
    </Card>
    <Card variant="elevated">
      <Typography variant="titleSmall">Elevated</Typography>
      <Typography variant="bodySmall">Raised off the background with a shadow.</Typography>
    </Card>
    <Card variant="glow">
      <Typography variant="titleSmall">Glow</Typography>
      <Typography variant="bodySmall">Accent halo for the primary call to action.</Typography>
    </Card>
  </div>
);
  ...
  <div style={{ width: 380 }}>
    <Card variant="elevated">
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        <Chip label="Design system" size="small" mode="tonal" onPress={() => {}} />
        <Chip label="Accessibility" size="small" mode="tonal" onPress={() => {}} />
      </div>
    </Card>
  </div>
);
...
export const Pressable = () => (
  <div style={stack}>
    <Card variant="filled" onPress={() => {}} accessibilityLabel="Open billing settings">
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={lines}>
          <Typography variant="titleSmall">Billing</Typography>
          <Typography variant="bodySmall">Visa ending 4021 · renews 12 Oct</Typography>
        </div>
        <StatusBadge label="Active" type="success" />
      </div>
    </Card>
    <Card variant="outlined" onPress={() => {}} accessibilityLabel="Review failed payment">
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={lines}>
  ...
  <div style={{ width: 380 }}>
    <Card variant="outlined">
      ...
      <Typography variant="bodyMedium">
        Everyone you invite gets read access to the shared component library. You can raise
        their role later from Settings.
      </Typography>
      {spacer(16)}
